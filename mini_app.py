...
def update_daily(date='2024-01-01'):
    ...
    asset_gen_fig = px.area(tester, x='Date (MST)', y=list(color_map.keys()), color_discrete_map=color_map, 
    ...
    price_fig = px.line(tester, x='Date (MST)', y='Avg. Price')
    ...
    EI_fig = px.scatter(tester, x='Date (MST)', y='RE_percent',
    ...
    gen_pie_daily = px.pie(df_pie, values='Sum', names='index', color = 'index',
